export const TOOLS = [
  {
    ...
    description:
      'Transcribe an audio file to text using Lumos cloud ASR via the configured Speech provider. Supports wav/mp3/m4a/ogg/aac/amr/silk/flac/webm/opus. Provide either file_path (local absolute path under home or /tmp) or base64 (raw audio bytes).',
    inputSchema: {
      type: 'object',
      properties: {
        file_path: {
