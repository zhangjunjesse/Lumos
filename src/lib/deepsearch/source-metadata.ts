...
export const DEEPSEARCH_SOURCE_REGISTRY: DeepSearchSourceMetadata[] = [
  ...
  },
  {
    ...
    notes: '生命科学高质量全文源。已在本机验证过 BioC JSON 获取。',
    validationNotes: '已用官方 BioC API 获取结构化全文 JSON。',
  },
  {
    id: 'europe_pmc',
    ...
    notes: '适合作为生命科学论文发现层，并跟进全文链接。已在本机验证搜索与全文链接字段。',
    validationNotes: '已验证搜索、摘要和全文链接字段；未做单篇全文二跳验证。',
  },
  {
    id: 'arxiv',
    displayName: 'arXiv',
