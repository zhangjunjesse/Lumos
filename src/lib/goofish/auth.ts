...
/**
 * Login modes:
 *   - 'qr':     opens a Playwright Chrome window with goofish.com's passport
 *               page, user scans on phone, captures cookies once login confirms.
 *               Most reliable — works even on a fresh machine.
