...
const PROVIDER_KEY = 'workflow_builder_provider_id';
const MODEL_KEY = 'workflow_builder_model';
const PROMPT_KEY = 'workflow_builder_system_prompt';
...
export async function GET() {
  return NextResponse.json({
    ...
    defaultSystemPrompt: WORKFLOW_REFINE_PROMPT,
  });
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const message = error instanceof Error ? error.message : 'Failed to update builder config';
