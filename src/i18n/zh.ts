...
const zh: Record<TranslationKey, string> = {
  ...
  'mind.loading': '正在加载内在世界快照...',
  'mind.loadError': '加载内在世界快照失败',
  'mind.retry': '重试',
  ...
  'mind.memories.sourceMindUi': '内在世界手动编辑',
  'mind.memories.sourceMindUiHint': '由你在内在世界页面新增或修改。',
  ...
  'mind.rules.runtimePackDesc': '预览 Persona + Rules + Memory 如何在每轮对话进入上下文。',
