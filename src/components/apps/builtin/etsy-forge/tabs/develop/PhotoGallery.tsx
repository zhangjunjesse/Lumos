...
import { ImagePlus, Loader2, RefreshCw, Star, Trash2, Upload } from 'lucide-react';
...
export function PhotoGallery({ photos, runningCount, onRefine, onSetMain, onRemove, onPick, onUpload }: Props) {
